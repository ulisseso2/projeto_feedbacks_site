    ...
    <div class="header-group">
      ...
      <div class="flex items-center justify-between py-10">
        <div class="w-28 lg:w-36">
          <img class="w-ful"  src="../../assets/images/logo.png" alt="logo">
        </div>
        <div class="flex" >
          <button
      ...
      <div class="flex flex-col mt-28">
        <h1 class="text-4xl font-black text-white">
          ...
          E faça seus clinetes mais <br class="hidden lg:inline-block">
          felizes!
        </h1>
        <p class="text-lg font-mediums text-white">
          Receba ideias, reclamações e feedbacks com um <br class="hidden lg:inline-block">
          simples widget na página.
        </p>
        <div>
          <button class="px-6 py-2 mt-10 bg-white font-bold text-brand-main rounded-full focus:outline-none">
...
@media (min-width: 640px){
  .header-group {
    background-image: url(../../assets/images/img_project.png);
